...
console.log(" ");
const arciotext = require('./handlers/arciotext')
...
const listener = app.listen(settings.website.port, function() {
  ...
  console.log(chalk.gray("🔗") + chalk.cyan("[") + chalk.white("Hclient") + chalk.cyan("]") + chalk.white(" Successfully loaded HolaClient ") + chalk.cyan("v" + settings.version) + chalk.white(" at ") + chalk.cyan(settings.api.client.oauth2.link + "/"));
console.log(" ");
